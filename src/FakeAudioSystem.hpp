...
namespace StretchPlayer
{
	...
	int set_process_callback(process_callback_t cb, void* arg, char* err_msg = 0) override;
	int set_segment_size_callback(segment_size_callback_t cb, void* arg, char* err_msg = 0) override;
